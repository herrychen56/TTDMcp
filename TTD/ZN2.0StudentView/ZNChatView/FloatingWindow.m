...
-(id)initWithFrame:(CGRect)frame imageName:(NSString *)name
{
    ...
    {
        self.backgroundColor =  [UIColor colorWithRed:0.99  green:0.27 blue:0.12 alpha:1.0];
...
//        _phoneFlowImageView3.alpha = 0.f;
        ...
        UILabel *timelable = [[UILabel alloc ] initWithFrame:CGRectMake(0, 8, SCREEN_WIDTH, 20)];
//        timelable.center = CGPointMake(frame.size.width /2, frame.size.height / 2 + 12);
//        timelable.font = [UIFont systemFontOfSize:14];
        [timelable setFont:[UIFont fontWithName:@"Helvetica-Bold" size:14]];
