//
//  ZN-ExtracurricularViewController.m
//  TTD
//
...
#import "ZN-ExtracurricularViewController.h"

@interface ZN_ExtracurricularViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong) UITableView * tableV;

@end

@implementation ZN_ExtracurricularViewController
...
-(void)createTab {
    self.tableV =[[UITableView alloc]initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, 150) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImageView * cellimg=[[UIImageView alloc]initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width-50, 10, 30, 30)];
