...
@interface LeLtsListViewController ()

@end

@implementation LeLtsListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0) {
        ...
        uplab.text =@"Reading";
        towlab.text =[NSString stringWithFormat:@"%@", [dic objectForKey:@"Reading"]];
    }else if (indexPath.row==2){
        uplab.text =@"Listening";
        towlab.text =[NSString stringWithFormat:@"%@", [dic objectForKey:@"Listening"]];
    }else if (indexPath.row ==3){
        uplab.text = @"Speaking";
        towlab.text = [NSString stringWithFormat:@"%@",[dic objectForKey:@"Speaking"]];
    }else if (indexPath.row ==4){
        uplab.text = @"Writing";
        towlab.text = [NSString stringWithFormat:@"%@",[dic objectForKey:@"Writing"]];
    }else if (indexPath.row ==5){
        uplab.text = @"Total";
        towlab.text = [NSString stringWithFormat:@"%@",[dic objectForKey:@"Total"]];
    }
    }
    return cell;
}
