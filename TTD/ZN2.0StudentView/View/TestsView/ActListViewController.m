...
@interface ActListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
//    [cell addSubview:onelab];
    ...
    if (indexPath.row==0) {
       ...
       towlab.layer.borderWidth = 0;
        ...
        uplab.text =@"English";
        towlab.text =[NSString stringWithFormat:@"%@", [dic objectForKey:@"English"]];
    }else if (indexPath.row==2){
        uplab.text =@"Math";
        towlab.text =[NSString stringWithFormat:@"%@", [dic objectForKey:@"Math"]];
    }else if (indexPath.row ==3){
        uplab.text = @"Reading";
        towlab.text = [NSString stringWithFormat:@"%@",[dic objectForKey:@"CriticalReading"]];
    }else if (indexPath.row==4){
        uplab.text =@"Science";
        towlab.text = [NSString stringWithFormat:@"%@",[dic objectForKey:@"Science"]];
    }else if (indexPath.row == 5){
        uplab.text =@"Eng/Wrt";
        towlab.text = [NSString stringWithFormat:@"%@",[dic objectForKey:@"Writing"]];
    }else if (indexPath.row == 6){
        uplab.text =@"Composite";
        towlab.text = [NSString stringWithFormat:@"%@",[dic objectForKey:@"SATEQ"]];
    }
    }
    return cell;
}
