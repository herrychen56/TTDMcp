...
@interface LseeListViewController ()

@end

@implementation LseeListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0) {
        ...
        uplab.text =@"Verbal Reasoning";
        towlab.text =[NSString stringWithFormat:@"%@", [dic objectForKey:@"Verbal Reasoning"]];
    }else if (indexPath.row==2){
        uplab.text =@"Reading Comprehension";
        towlab.text =[NSString stringWithFormat:@"%@", [dic objectForKey:@"Reading Comprehension"]];
    }else if (indexPath.row ==3){
        uplab.text = @"Quantitative Reasoning";
        towlab.text = [NSString stringWithFormat:@"%@",[dic objectForKey:@"Quantitative Reasoning"]];
    }
    else if (indexPath.row ==5){
        uplab.text = @"Mathematics Achievement";
        towlab.text = [NSString stringWithFormat:@"%@",[dic objectForKey:@"Mathematics Achievement"]];
    }
    }
    return cell;
}
