...
@interface SSatListViewController ()

@end

@implementation SSatListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0) {
        ...
        uplab.text =@"Verbal";
        towlab.text =[NSString stringWithFormat:@"%@", [dic objectForKey:@"Verbal"]];
