...
@interface APListViewController ()
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0) {
        ...
        uplab.text =@"AP Subject Name";
        towlab.text =[NSString stringWithFormat:@"%@", [dic objectForKey:@"APSubjectName"]];
    }else if (indexPath.row==2){
        uplab.text =@"AP Subject ID";
        towlab.text =[NSString stringWithFormat:@"%@", [dic objectForKey:@"APSubjectID"]];
