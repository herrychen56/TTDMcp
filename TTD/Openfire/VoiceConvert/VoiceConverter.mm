...
+ (NSInteger)amrToWav:(NSString*)_amrPath wavSavePath:(NSString*)_savePath{
    //DecodeAMRFileToWAVEFile
...
+ (NSInteger)wavToAmr:(NSString*)_wavPath amrSavePath:(NSString*)_savePath{
