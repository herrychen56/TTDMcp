...
#define NSLog(frmt, ...)  do{ if(LOG_LEVEL >= 4) NSLog((frmt), ##__VA_ARGS__); } while(0)
...
//        NSLog(@"DDTTYLogger: %3lu : %.3f,%.3f,%.3f & %.3f,%.3f,%.3f = %.6f",
...
//            NSLog(@"DDTTYLogger: New best index = %lu", (unsigned long)bestIndex);
		}
