...
- (CGFloat)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		else
		{
			...
			if (total > 0)
				result = (CGFloat)done / (CGFloat)total;
			else
				result = 1.0F;
		}
	};
...
- (CGFloat)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	__block CGFloat result = 0.0F;
