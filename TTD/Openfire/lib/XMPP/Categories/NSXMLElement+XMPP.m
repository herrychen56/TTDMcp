...
- (CGFloat)attributeFloatValueForName:(NSString *)name
{
...
- (CGFloat)attributeFloatValueForName:(NSString *)name withDefaultValue:(CGFloat)defaultValue
{
	NSXMLNode *attr = [self attributeForName:name];
