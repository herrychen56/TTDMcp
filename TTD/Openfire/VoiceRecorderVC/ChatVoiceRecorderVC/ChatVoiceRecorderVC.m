...
- (void)beginRecordByFileName:(NSString*)_fileName;{
   ...
   // NSLog(@"wav path is %@",self.recordFilePath);
    //初始化录音
   ...
   // [self startTimer];
    ...
    //herry
    [self performSelector:@selector(endRecord) withObject:nil afterDelay:60];
    //显示录音界面
 /*   [self initRecordView];
...
- (void)updateMeters {
    ...
    if (voiceHud_)
    {
        ...
        CGFloat peakPower = [recorder averagePowerForChannel:0];
        double ALPHA = 0.05;
