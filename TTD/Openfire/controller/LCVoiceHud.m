...
- (UIImage *) partialImageWithPercentage:(CGFloat)percentage
...
- (UIImage *) partialImageWithPercentage:(CGFloat)percentage vertical:(BOOL)vertical grayscaleRest:(BOOL)grayscaleRest {
    const int ALPHA = 0;
    const int RED = 1;
    const int GREEN = 2;
    const int BLUE = 3;
