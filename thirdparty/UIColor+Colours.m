...
{
    return [UIColor colorFromHexString:@"#007AFF" alpha:1.0];
}
...
+ (UIColor *)colorMainText
{
    return [UIColor colorFromHexString:@"#747989" alpha:1.0];
}

+ (UIColor *)colorAssistText
{
    return [UIColor colorFromHexString:@"#747989" alpha:0.5];
}

+ (UIColor *)colorBackground {
    return [UIColor colorFromHexString:@"#f3f4f7" alpha:1.0];
}

+ (UIColor *)colorBlackAlpha20 {
    return [UIColor colorFromHexString:@"000000" alpha:0.2];
}
